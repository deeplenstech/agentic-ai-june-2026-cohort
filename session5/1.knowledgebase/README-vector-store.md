# Assignment 1 (Vector Store): AWS Bedrock Knowledge Base

> This is the **vector-store** approach. For an overview of how it differs from the vectorless
> (PageIndex) approach — and to switch — see the [approach chooser](README.md).
